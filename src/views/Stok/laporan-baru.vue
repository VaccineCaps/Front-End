      ...
      >
        <v-row>
          ...
          <v-col cols="1" class="text-end my-2">
            <v-icon color="primary">mdi-circle</v-icon></v-col
          >
        </v-row>
      </v-app-bar>
      <br />
  ...
  methods: {
    pushPage() {
      return this.$router.push(
        "/admin/stok-vaksin/laporan-baru/registrasi-vaksin-keluar"
      );
    },
    redirect() {
      return this.$router.push(
        "/admin/stok-vaksin/laporan-baru/registrasi-vaksin-masuk"
      );
    },
  },
};
